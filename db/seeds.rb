...
Equipment.create!(address: "1360 rue Guizot, Montreal", name: "Float", sport: "Beach", price: 10, description: "Use it on the deck or in the water, the Suntan Oasis is the ultimate way to relax as you tan. Measuring 71 in. L, this comfortable lounger is the perfect size for almost any adult to drift their cares way. Features a clear reflective top for even tanning, separate inflatable pillow, a self-draining bottom and a grab rope. On extra hot days simply fill the Suntan Oasis with water to cool off." ,remote_photo_url: "https://images.unsplash.com/photo-1525654844438-6667c015f3ff?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80", user: User.first)
