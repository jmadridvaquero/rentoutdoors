...
#Create 5 equipment
Equipment.create!(address: "124 Rue Saint Viateur, Montréal, QC H2T 2L1", name: "Kayak", sport: "Kayakink", price: 20, description: "A very nice Kayak" ,remote_photo_url: "https://images.unsplash.com/photo-1544407558-71e53c6a1136?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2089&q=80", user: User.first)
sleep(2)
...
sleep(2)
Equipment.create!(address: "6584 Boul St-Laurent, Montréal, QC H2S 3C6", name: "Kayak", sport: "Kayakink", price: 20, description: "A very nice blue Kayak" ,remote_photo_url: "https://images.unsplash.com/photo-1489746180847-52dab13d0639?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2084&q=80", user: User.first)
