...
sleep(1)
Equipment.create!(address: "1360 rue de Liege, Montreal", name: "Float", sport: "River", price: 20, description: "Use it on the deck or in the water, the Suntan Oasis is the ultimate way to relax as you tan. Measuring 71 in. L, this comfortable lounger is the perfect size for almost any adult to drift their cares way. Features a clear reflective top for even tanning, separate inflatable pillow, a self-draining bottom and a grab rope. On extra hot days simply fill the Suntan Oasis with water to cool off." ,remote_photo_url: "https://images.unsplash.com/photo-1534109287195-26cc74f4940f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80", user: User.first)
